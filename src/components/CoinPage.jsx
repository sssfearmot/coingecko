    ...
    return (
        <div>
            <div className='rounded-div mt-6 py-4'>
                ...
                {loading ? (
                    <div className='flex justify-between'>
                        <div className='flex-col'>
                            ...
                            <div className='mt-4'>
                                <Sparklines svgWidth={450} data={data.market_data?.sparkline_7d.price}>
                                    <SparklinesLine color="lightblue" />
                                </Sparklines>
                            </div>
                        </div>

                        {/* <HistoryChart id={params.coinId} /> */}

                        <div className='my-4 hidden 1sm:block'>
                            <h2 className='text-xl font-semibold'>정보</h2>
                            <div className='my-1'>
                                <div className='my-2'>
                                    <small className='text-gray-600 dark:text-gray-400 font-semibold'>웹사이트</small>
                                    <div className='my-1'>
                                ...
                                <div>
                                    <small className='text-gray-600 dark:text-gray-400 font-semibold'>커뮤니티</small>
                                ...
                                <div>
                                    <small className='text-gray-600 dark:text-gray-400 font-semibold'>소스 코드</small>
                                    <div className='my-1'>
                ...
                {data.market_data && (
                    <div className='grid gap-3 md:grid-cols-2 1sm:grid-cols-1 mt-4'>
                        <div className='border-b'>
                            <h4 className='text-gray-500 dark:text-gray-400 text-sm'>시가총액</h4>
                            <p className='font-semibold'>${data.market_data.market_cap.usd.toLocaleString()}</p>
                        </div>
                        <div className='border-b'>
                            <h4 className='text-gray-500 dark:text-gray-400 text-sm'>24시간 거래대금</h4>
                            <p className='font-semibold'>${data.market_data.total_volume.usd.toLocaleString()}</p>
                        </div>
                        {data.market_data.fully_diluted_valuation.usd &&
                            <div className='border-b'>
                                <h4 className='text-gray-500 dark:text-gray-400 text-sm'>가치 완전 희석</h4>
                                <p className='font-semibold'>${data.market_data.fully_diluted_valuation.usd.toLocaleString()}</p>
                            </div>
                        }
                        <div className='border-b'>
                            <h4 className='text-gray-500 dark:text-gray-400 text-sm'>유통량</h4>
                            <p className='font-semibold'>{data.market_data.circulating_supply.toLocaleString()}</p>
                        </div>
                        <div className='border-b'>
                            <h4 className='text-gray-500 dark:text-gray-400 text-sm'>24시간 고가</h4>
                            <p className='font-semibold'>${data.market_data.high_24h.usd.toLocaleString()}</p>
                        </div>
                        <div className='border-b'>
                            <h4 className='text-gray-500 dark:text-gray-400 text-sm'>24시간 저가</h4>
